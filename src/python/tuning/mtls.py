...
def objective(trial: optuna.trial.Trial,
    ...
    fixed_params_for_trial = {
        # "num_layers": num_layers, # Currently tunable
    ...
    model = MtlsModel( # Use MtlsModel
        input_dim=input_dim,
        lstm_dim=current_params["lstm_dim"], # Use lstm_dim
        output_dim=output_dim,
        lstm_expansion_factor=current_params["lstm_expansion"], # Use lstm_expansion
    ...
    print(f"\nTrial {trial.number}: PARAMS lr={current_params['lr']:.6f}, dropout={current_params['dropout_rate']:.2f}, wd={current_params['weight_decay']:.6f}, "
          f"lstm_dim={current_params['lstm_dim']}, layers={current_params['num_layers']}, expansion={current_params['lstm_expansion']:.2f}, act={current_params['activation_fn_name']}, "
